 ...
 * 2019-09-11T15:45:35.912+02:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "ReportIncidentEndpointService", 
                  wsdlLocation = "file:/home/mauro/repo/camel/examples/camel-example-reportincident-wssecurity/src/main/resources/etc/report_incident.wsdl",
...
public class ReportIncidentEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/mauro/repo/camel/examples/camel-example-reportincident-wssecurity/src/main/resources/etc/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/mauro/repo/camel/examples/camel-example-reportincident-wssecurity/src/main/resources/etc/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }
