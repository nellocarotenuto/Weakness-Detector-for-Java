...
public final class BoxApiCollection extends ApiCollection<BoxApiName, BoxConfiguration> {
    ...
    private BoxApiCollection() {
        ...
        aliases.put("downloadPreviousFileVersions", "downloadVersion");
        ...
        nullableArgs = Arrays.asList("fields", "created", "modified", "size", "fileSize", "rangeStart", "rangeEnd", "listener", "fileSize", "newName", "unshareDate", "permissions", "typeName");
