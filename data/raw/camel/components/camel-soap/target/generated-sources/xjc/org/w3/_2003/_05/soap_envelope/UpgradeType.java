...
// Generated on: 2019.09.11 at 03:28:06 PM CEST 
//
...
public class UpgradeType {
    ...
    public UpgradeType withSupportedEnvelope(SupportedEnvType... values) {
        if (values!= null) {
            for (SupportedEnvType value: values) {
                getSupportedEnvelope().add(value);
            }
        }
        return this;
    }

    public UpgradeType withSupportedEnvelope(Collection<SupportedEnvType> values) {
        if (values!= null) {
            getSupportedEnvelope().addAll(values);
        }
        return this;
    }
