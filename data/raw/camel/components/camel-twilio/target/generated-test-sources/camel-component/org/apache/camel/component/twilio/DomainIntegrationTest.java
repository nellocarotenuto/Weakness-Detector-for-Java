...
import org.apache.camel.component.twilio.internal.DomainApiMethod;

/**
 * Test class for {@link com.twilio.rest.api.v2010.account.sip.Domain} APIs.
 * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.
 * The class source won't be generated again if the generator MOJO finds it under src/test/java.
 */
public class DomainIntegrationTest extends AbstractTwilioTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(DomainIntegrationTest.class);
    private static final String PATH_PREFIX = TwilioApiCollection.getCollection().getApiName(DomainApiMethod.class).getName();

    // TODO provide parameter values for creator
    @Ignore
    @Test
    public void testCreator() throws Exception {
        // using String message body for single parameter "domainName"
        final com.twilio.rest.api.v2010.account.sip.DomainCreator result = requestBody("direct://CREATOR", null);
    ...
    public void testCreator_1() throws Exception {
        ...
        // parameter type is String
        headers.put("CamelTwilio.domainName", null);

        final com.twilio.rest.api.v2010.account.sip.DomainCreator result = requestBodyAndHeaders("direct://CREATOR_1", null, headers);
    ...
    public void testDeleter() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.sip.DomainDeleter result = requestBody("direct://DELETER", null);
    ...
    public void testDeleter_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.sip.DomainDeleter result = requestBodyAndHeaders("direct://DELETER_1", null, headers);
    ...
    public void testFetcher() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.sip.DomainFetcher result = requestBody("direct://FETCHER", null);
    ...
    public void testFetcher_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.sip.DomainFetcher result = requestBodyAndHeaders("direct://FETCHER_1", null, headers);
    ...
    public void testReader() throws Exception {
        final com.twilio.rest.api.v2010.account.sip.DomainReader result = requestBody("direct://READER", null);
    ...
    public void testReader_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.sip.DomainReader result = requestBody("direct://READER_1", null);
    ...
    public void testUpdater() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.sip.DomainUpdater result = requestBody("direct://UPDATER", null);
    ...
    public void testUpdater_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.sip.DomainUpdater result = requestBodyAndHeaders("direct://UPDATER_1", null, headers);
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct://CREATOR")
                    .to("twilio://" + PATH_PREFIX + "/creator?inBody=domainName");
