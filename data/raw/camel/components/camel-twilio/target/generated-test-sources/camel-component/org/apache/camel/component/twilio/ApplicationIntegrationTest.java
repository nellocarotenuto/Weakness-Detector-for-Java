...
import org.apache.camel.component.twilio.internal.ApplicationApiMethod;

/**
 * Test class for {@link com.twilio.rest.api.v2010.account.Application} APIs.
 * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.
 * The class source won't be generated again if the generator MOJO finds it under src/test/java.
 */
public class ApplicationIntegrationTest extends AbstractTwilioTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(ApplicationIntegrationTest.class);
    private static final String PATH_PREFIX = TwilioApiCollection.getCollection().getApiName(ApplicationApiMethod.class).getName();
    ...
    public void testCreator() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationCreator result = requestBody("direct://CREATOR", null);
    ...
    public void testCreator_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationCreator result = requestBodyAndHeaders("direct://CREATOR_1", null, headers);
    ...
    public void testDeleter() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationDeleter result = requestBody("direct://DELETER", null);
    ...
    public void testDeleter_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationDeleter result = requestBodyAndHeaders("direct://DELETER_1", null, headers);
    ...
    public void testFetcher() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.ApplicationFetcher result = requestBody("direct://FETCHER", null);
    ...
    public void testFetcher_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationFetcher result = requestBodyAndHeaders("direct://FETCHER_1", null, headers);
    ...
    public void testReader() throws Exception {
        final com.twilio.rest.api.v2010.account.ApplicationReader result = requestBody("direct://READER", null);
    ...
    public void testReader_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationReader result = requestBody("direct://READER_1", null);
    ...
    public void testUpdater() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.ApplicationUpdater result = requestBody("direct://UPDATER", null);
    ...
    public void testUpdater_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ApplicationUpdater result = requestBodyAndHeaders("direct://UPDATER_1", null, headers);
