...
import org.apache.camel.component.twilio.internal.QueueApiMethod;

/**
 * Test class for {@link com.twilio.rest.api.v2010.account.Queue} APIs.
 * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.
 * The class source won't be generated again if the generator MOJO finds it under src/test/java.
 */
public class QueueIntegrationTest extends AbstractTwilioTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(QueueIntegrationTest.class);
    private static final String PATH_PREFIX = TwilioApiCollection.getCollection().getApiName(QueueApiMethod.class).getName();
    ...
    public void testCreator() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueCreator result = requestBody("direct://CREATOR", null);
    ...
    public void testCreator_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueCreator result = requestBodyAndHeaders("direct://CREATOR_1", null, headers);
    ...
    public void testDeleter() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueDeleter result = requestBody("direct://DELETER", null);
    ...
    public void testDeleter_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueDeleter result = requestBodyAndHeaders("direct://DELETER_1", null, headers);
    ...
    public void testFetcher() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.QueueFetcher result = requestBody("direct://FETCHER", null);
    ...
    public void testFetcher_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueFetcher result = requestBodyAndHeaders("direct://FETCHER_1", null, headers);
    ...
    public void testReader() throws Exception {
        final com.twilio.rest.api.v2010.account.QueueReader result = requestBody("direct://READER", null);
    ...
    public void testReader_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueReader result = requestBody("direct://READER_1", null);
    ...
    public void testUpdater() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.QueueUpdater result = requestBody("direct://UPDATER", null);
    ...
    public void testUpdater_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.QueueUpdater result = requestBodyAndHeaders("direct://UPDATER_1", null, headers);
