...
import org.apache.camel.component.twilio.internal.ConferenceApiMethod;

/**
 * Test class for {@link com.twilio.rest.api.v2010.account.Conference} APIs.
 * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.
 * The class source won't be generated again if the generator MOJO finds it under src/test/java.
 */
public class ConferenceIntegrationTest extends AbstractTwilioTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(ConferenceIntegrationTest.class);
    private static final String PATH_PREFIX = TwilioApiCollection.getCollection().getApiName(ConferenceApiMethod.class).getName();
    ...
    public void testFetcher() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ConferenceFetcher result = requestBody("direct://FETCHER", null);
    ...
    public void testFetcher_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ConferenceFetcher result = requestBodyAndHeaders("direct://FETCHER_1", null, headers);
    ...
    public void testReader() throws Exception {
        final com.twilio.rest.api.v2010.account.ConferenceReader result = requestBody("direct://READER", null);
    ...
    public void testReader_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ConferenceReader result = requestBody("direct://READER_1", null);
    ...
    public void testUpdater() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.ConferenceUpdater result = requestBody("direct://UPDATER", null);
    ...
    public void testUpdater_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.ConferenceUpdater result = requestBodyAndHeaders("direct://UPDATER_1", null, headers);
