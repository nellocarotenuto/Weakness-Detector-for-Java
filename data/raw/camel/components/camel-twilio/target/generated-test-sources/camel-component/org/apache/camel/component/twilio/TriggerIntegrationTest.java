...
import org.apache.camel.component.twilio.internal.TriggerApiMethod;

/**
 * Test class for {@link com.twilio.rest.api.v2010.account.usage.Trigger} APIs.
 * TODO Move the file to src/test/java, populate parameter values, and remove @Ignore annotations.
 * The class source won't be generated again if the generator MOJO finds it under src/test/java.
 */
public class TriggerIntegrationTest extends AbstractTwilioTestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(TriggerIntegrationTest.class);
    private static final String PATH_PREFIX = TwilioApiCollection.getCollection().getApiName(TriggerApiMethod.class).getName();
    ...
    public void testCreator() throws Exception {
        ...
        headers.put("CamelTwilio.callbackUrl", null);
        // parameter type is String
        headers.put("CamelTwilio.triggerValue", null);
        // parameter type is com.twilio.rest.api.v2010.account.usage.Trigger.UsageCategory
        headers.put("CamelTwilio.usageCategory", null);

        final com.twilio.rest.api.v2010.account.usage.TriggerCreator result = requestBodyAndHeaders("direct://CREATOR", null, headers);
    ...
    public void testCreator_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerCreator result = requestBodyAndHeaders("direct://CREATOR_1", null, headers);
    ...
    public void testDeleter() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerDeleter result = requestBody("direct://DELETER", null);
    ...
    public void testDeleter_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerDeleter result = requestBodyAndHeaders("direct://DELETER_1", null, headers);
    ...
    public void testFetcher() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.usage.TriggerFetcher result = requestBody("direct://FETCHER", null);
    ...
    public void testFetcher_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerFetcher result = requestBodyAndHeaders("direct://FETCHER_1", null, headers);
    ...
    public void testReader() throws Exception {
        final com.twilio.rest.api.v2010.account.usage.TriggerReader result = requestBody("direct://READER", null);
    ...
    public void testReader_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerReader result = requestBody("direct://READER_1", null);
    ...
    public void testUpdater() throws Exception {
        // using String message body for single parameter "pathSid"
        final com.twilio.rest.api.v2010.account.usage.TriggerUpdater result = requestBody("direct://UPDATER", null);
    ...
    public void testUpdater_1() throws Exception {
        ...
        final com.twilio.rest.api.v2010.account.usage.TriggerUpdater result = requestBodyAndHeaders("direct://UPDATER_1", null, headers);
