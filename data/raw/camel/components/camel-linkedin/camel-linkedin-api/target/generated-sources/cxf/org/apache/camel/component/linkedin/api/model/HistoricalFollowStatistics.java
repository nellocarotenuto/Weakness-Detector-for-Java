...
@XmlRootElement(name = "historical-follow-statistics")
public class HistoricalFollowStatistics {

    @XmlElement(name = "statistic")
    protected List<HistoricalFollowStatistic> statisticList;
     ...
     * {@link HistoricalFollowStatistic }
     * 
     * 
     */
    public List<HistoricalFollowStatistic> getStatisticList() {
        if (statisticList == null) {
            statisticList = new ArrayList<HistoricalFollowStatistic>();
        }
