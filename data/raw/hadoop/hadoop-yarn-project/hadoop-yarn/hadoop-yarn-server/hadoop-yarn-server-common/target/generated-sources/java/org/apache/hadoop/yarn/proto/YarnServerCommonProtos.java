...
public final class YarnServerCommonProtos {
  ...
  public static final class NodeStatusProto extends
    ...
    public org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProto getOpportunisticContainersStatus() {
      return opportunisticContainersStatus_;
    }
    /**
     * <code>optional .hadoop.yarn.OpportunisticContainersStatusProto opportunistic_containers_status = 9;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        output.writeMessage(9, opportunisticContainersStatus_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000020) == 0x00000020)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, opportunisticContainersStatus_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasOpportunisticContainersStatus() == other.hasOpportunisticContainersStatus());
      if (hasOpportunisticContainersStatus()) {
        result = result && getOpportunisticContainersStatus()
            .equals(other.getOpportunisticContainersStatus());
      }
      result = result &&
    ...
    public static final class Builder extends
      ...
      // optional .hadoop.yarn.OpportunisticContainersStatusProto opportunistic_containers_status = 9;
      private org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProto opportunisticContainersStatus_ = org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProto.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          getOpportunisticContainersStatusFieldBuilder() {
        if (opportunisticContainersStatusBuilder_ == null) {
          opportunisticContainersStatusBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProto, org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProto.Builder, org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProtoOrBuilder>(
                  opportunisticContainersStatus_,
                  getParentForChildren(),
                  isClean());
  ...
  public interface OpportunisticContainersStatusProtoOrBuilder
      extends com.google.protobuf.MessageOrBuilder {
  ...
  public static final class OpportunisticContainersStatusProto extends
      com.google.protobuf.GeneratedMessage
      implements OpportunisticContainersStatusProtoOrBuilder {
    // Use OpportunisticContainersStatusProto.newBuilder() to construct.
    private OpportunisticContainersStatusProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
      this.unknownFields = builder.getUnknownFields();
    }
    private OpportunisticContainersStatusProto(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

    private static final OpportunisticContainersStatusProto defaultInstance;
    public static OpportunisticContainersStatusProto getDefaultInstance() {
      return defaultInstance;
    }

    public OpportunisticContainersStatusProto getDefaultInstanceForType() {
      return defaultInstance;
    }
    ...
    public static com.google.protobuf.Parser<OpportunisticContainersStatusProto> PARSER =
        new com.google.protobuf.AbstractParser<OpportunisticContainersStatusProto>() {
    ...
    @java.lang.Override
    public com.google.protobuf.Parser<OpportunisticContainersStatusProto> getParserForType() {
      return PARSER;
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      boolean result = true;
      result = result && (hasRunningOpportContainers() == other.hasRunningOpportContainers());
      if (hasRunningOpportContainers()) {
        result = result && (getRunningOpportContainers()
            == other.getRunningOpportContainers());
      }
      result = result && (hasOpportMemoryUsed() == other.hasOpportMemoryUsed());
      if (hasOpportMemoryUsed()) {
        result = result && (getOpportMemoryUsed()
            == other.getOpportMemoryUsed());
      }
      result = result && (hasOpportCoresUsed() == other.hasOpportCoresUsed());
      if (hasOpportCoresUsed()) {
        result = result && (getOpportCoresUsed()
            == other.getOpportCoresUsed());
      }
      result = result && (hasQueuedOpportContainers() == other.hasQueuedOpportContainers());
      if (hasQueuedOpportContainers()) {
        result = result && (getQueuedOpportContainers()
            == other.getQueuedOpportContainers());
      }
      ...
      result = result && (hasOpportQueueCapacity() == other.hasOpportQueueCapacity());
      if (hasOpportQueueCapacity()) {
        result = result && (getOpportQueueCapacity()
            == other.getOpportQueueCapacity());
      }
      result = result &&
          getUnknownFields().equals(other.getUnknownFields());
      return result;
    ...
    public int hashCode() {
      ...
      if (hasOpportMemoryUsed()) {
        ...
        hash = (53 * hash) + hashLong(getOpportMemoryUsed());
      }
      if (hasOpportCoresUsed()) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements org.apache.hadoop.yarn.proto.YarnServerCommonProtos.OpportunisticContainersStatusProtoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return org.apache.hadoop.yarn.proto.YarnServerCommonProtos.internal_static_hadoop_yarn_OpportunisticContainersStatusProto_descriptor;
      }
    ...
    static {
      defaultInstance = new OpportunisticContainersStatusProto(true);
      defaultInstance.initFields();
    }
